...
export default function PorcentajeTareasCompletadasPorTipoTable({ data }: PorcentajeTareasCompletadasPorTipoTableProps) {
  return (
    <div className="relative mx-8 my-6 p-6 bg-white shadow-lg rounded-lg">
      <h2 className="text-2xl font-bold text-gray-700 mb-6">Porcentaje de Tareas Completadas por Tipo</h2>
        ...
        <tbody>
          {data.map((item, index) => (
            <tr key={index} className="border-b hover:bg-gray-100">
              ...
              <td className="px-6 py-4 text-center">{item.porcentajeCompletado}%</td>
            </tr>
          ))}
        </tbody>
      </table>
